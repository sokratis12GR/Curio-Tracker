...
DEFAULT_TOAST_Y_OFFSET = 80
DEFAULT_TOAST_X_OFFSET = 0
DEFAULT_TOAST_DURATION = 5
DEFAULT_TOAST_ENABLE = True
DEFAULT_TOP_RIGHT_CAPTURE_PERCENT = 0.01
...
DEFAULT_TOAST_IMAGE_WIDTH = 200
TOAST_IMAGE_WIDTH_MIN = 80
TOAST_IMAGE_WIDTH_MAX = 800

DEFAULT_TOAST_IMAGE_HEIGHT = 40
TOAST_IMAGE_HEIGHT_MIN = 20
TOAST_IMAGE_HEIGHT_MAX = 200

DEFAULT_TOAST_FONT_SIZE = 11
TOAST_FONT_SIZE_MIN = 8
TOAST_FONT_SIZE_MAX = 60

DEFAULT_TOAST_HEADLINE_FONT_SIZE = 10
